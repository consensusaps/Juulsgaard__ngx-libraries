...
export abstract class BaseInputComponent<TVal, TInputVal> implements OnInit, OnDestroy {
    ...
    @Input() set value$(value$: Subject<TVal|undefined>|Subscribable<TVal|undefined>) {
    ...
    protected constructor(@Optional() @Host() @SkipSelf() private controlContainer?: ControlContainer, @Optional() private formScope?: FormScopeService) {
        this.control = new FormNode(InputTypes.Generic, this.preprocessValue());
